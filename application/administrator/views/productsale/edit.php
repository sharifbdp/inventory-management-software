    ...
    <div align="center">
        <div class="inner_mid" >
            ...
            <div class="top_bar" >
                ...
                <div class="top_bar_left" >  Edit Product Sale Information  </div>
                ...
                <table width="900" border="0" align="center" cellpadding="5" cellspacing="0">
                        ...
                        <td height="25" align="left"><div class="table_blank">
                                <select name="product_id" id="product_id">
                                    ...
                                    if (!empty($content->product_id)) {
                                        ...
                                        <option value="<?php echo $sub_sub_cate->id; ?>"><?php echo $sub_sub_cate->name; ?></option>
                                    <?php } ?>
                                </select>
                    ...
                    <tr>
                        ...
                        <td height="25" align="left"><div class="" >
                                <?php
                                echo form_input(array('name' => 'product_price', 'id' => 'product_price', 'value' => $content->product_price, 'size' => '10'));
                                ?> &nbsp;&nbsp;Taka
                            </div></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td height="25" align="left">
                            <div class="">
                                <?php
                                echo form_input(array('name' => 'quantity', 'id' => 'quantity', 'value' => $content->quantity, 'size' => '5'));
                                ?> &nbsp;&nbsp;Pics&nbsp;&nbsp; 
                    ...
                    <tr> 
                        ...
                        <td height="25" align="left"> 
                            <div class="" >
                                <?php
                                echo form_input(array('name' => 'sale_date', 'id' => 'sale_date', 'value' => $content->sale_date, 'size' => '10'))
                                ?> </div>
                    ...
                    <tr> 
                        ...
                        <td height="25" align="left"> 
                            <div class="" >
                                <?php
                                echo form_input(array('name' => 'warranty_start', 'id' => 'warranty_start', 'value' => $content->warranty_start, 'size' => '10'))
                                ?> </div>
                    ...
                    <tr> 
                        ...
                        <td height="25" align="left"> 
                            <div class="" >
                                <?php
                                echo form_input(array('name' => 'warranty_end', 'id' => 'warranty_end', 'value' => $content->warranty_end, 'size' => '10'))
                                ?> </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#product_id').click(function() {
            ...
            $.ajax({
                ...
                success: function(datas) {
                    ...
                    datas_q = Number(datas.in_stock) + Number($('#quantity').val());
        ...
        $('#quantity').keyup(function() {
            ...
            var total_price = Number(quan) * Number(product_price);
